...
def maze_to_sdf(maze, wall_size=0.75, wall_height=1, gap=2):
...
width, height = 6, 6  # Smaller Maze dimensions (8x8)
...
# Convert the maze to SDF format
sdf_content = maze_to_sdf(maze, wall_size, wall_height, gap)

# Write the generated world content to a file in the specified directory
save_directory = "/home/s-kia/catkin_ws/src/random_map"
file_path = f"{save_directory}/random_maze.world"
...
print(f"Maze world file has been generated and saved to: {file_path}")
